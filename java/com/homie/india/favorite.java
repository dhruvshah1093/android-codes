...
public class favorite extends Activity implements ListView.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener {
    ...
    public void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(favorite.this,"Fetching Data","Wait...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                id=settings.getString("user_id","");
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam(Config.URL_GET_FAVORITE,id);
                return s;
            }
        }
