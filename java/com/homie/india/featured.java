...
public class featured extends Activity implements ListView.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener {
    ...
    public void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(featured.this,"Fetching Data","Wait...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(Config.URL_GET_FEATURED);
                return s;
            }
        }
